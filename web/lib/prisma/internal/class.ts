...
config.runtimeDataModel = JSON.parse("{\"models\":{\"table_kpi_marketing\":{\"fields\":[{\"name\":\"id\",\"kind\":\"scalar\",\"type\":\"Int\"},{\"name\":\"tasklist\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"kpi\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"karyawan\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"deadline\",\"kind\":\"scalar\",\"type\":\"DateTime\"},{\"name\":\"aktual\",\"kind\":\"scalar\",\"type\":\"DateTime\"}],\"dbName\":\"table_kpi_marketing\"}},\"enums\":{},\"types\":{}}")
config.parameterizationSchema = {
  strings: JSON.parse("[\"where\",\"table_kpi_marketing.findUnique\",\"table_kpi_marketing.findUniqueOrThrow\",\"orderBy\",\"cursor\",\"table_kpi_marketing.findFirst\",\"table_kpi_marketing.findFirstOrThrow\",\"table_kpi_marketing.findMany\",\"data\",\"table_kpi_marketing.createOne\",\"table_kpi_marketing.createMany\",\"table_kpi_marketing.createManyAndReturn\",\"table_kpi_marketing.updateOne\",\"table_kpi_marketing.updateMany\",\"table_kpi_marketing.updateManyAndReturn\",\"create\",\"update\",\"table_kpi_marketing.upsertOne\",\"table_kpi_marketing.deleteOne\",\"table_kpi_marketing.deleteMany\",\"having\",\"_count\",\"_avg\",\"_sum\",\"_min\",\"_max\",\"table_kpi_marketing.groupBy\",\"table_kpi_marketing.aggregate\",\"AND\",\"OR\",\"NOT\",\"id\",\"tasklist\",\"kpi\",\"karyawan\",\"deadline\",\"aktual\",\"equals\",\"in\",\"notIn\",\"lt\",\"lte\",\"gt\",\"gte\",\"not\",\"contains\",\"startsWith\",\"endsWith\",\"set\",\"increment\",\"decrement\",\"multiply\",\"divide\"]"),
...
export interface PrismaClientConstructor {
   ...
   * })
   * // Fetch zero or more Table_kpi_marketings
...
/**
  ...
  $extends: runtime.Types.Extensions.ExtendsHook<"extends", Prisma.TypeMapCb<OmitOpts>, ExtArgs, runtime.Types.Utils.Call<Prisma.TypeMapCb<OmitOpts>, {
    extArgs: ExtArgs
      ...
      /**
   * `prisma.table_kpi_marketing`: Exposes CRUD operations for the **table_kpi_marketing** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more Table_kpi_marketings
    * const table_kpi_marketings = await prisma.table_kpi_marketing.findMany()
    * ```
    */
  get table_kpi_marketing(): Prisma.table_kpi_marketingDelegate<ExtArgs, { omit: OmitOpts }>;
}
